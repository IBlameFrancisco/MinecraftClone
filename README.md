...
- **Randomised arenas:** the battle arena is re-skinned each match into one of four cinematic worlds — a golden-hour **Ruins**, a lush **Jungle** (treeline walls, canopy cover, water), a frozen **Tundra** (snow + ice spires), or a scorched **Desert** (dunes + cacti) — each with its own palette, lighting and sky. Same balanced layout, a different place every time.
